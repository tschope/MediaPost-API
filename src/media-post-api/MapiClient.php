...
use MapiException\MapiException;
...
class MapiClient {
	...
	/**
	 *	M�todo que altera a URL Base da API
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 17/03/2011
	 *	@return 
	...
	/**
	 *	M�todo que retorna a URL Base da API
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 17/03/2011
	 *	@return 
	...
	/**
	 *	M�todo que define um ConsumerKey
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 16/03/2011
	 *	@return 
	...
	/**
	 *	M�todo que define um ConsumerSecret
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 16/03/2011
	 *	@return 
	...
	/**
	 *	M�todo que define um TokenSecret
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 16/03/2011
	 *	@return 
	...
	/**
	 *	M�todo que encoda uma string para utf8
	 *	@access public
	 *	@author Diego Matos <diego@mt4.com.br>
	 *	@since 06/06/2011
	 *	@return 
